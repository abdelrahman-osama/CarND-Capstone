...
if("TRUE" STREQUAL "TRUE")
  set(tl_detector_SOURCE_PREFIX /home/pc1/CarND-Capstone-HNEW/ros/src/tl_detector)
  set(tl_detector_DEVEL_PREFIX /home/pc1/CarND-Capstone-HNEW/ros/devel)
  ...
  set(tl_detector_INSTALL_PREFIX /home/pc1/CarND-Capstone-HNEW/ros/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tl_detector' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pc1/CarND-Capstone-HNEW/ros/src/tl_detector/${idir}'.  ${_report}")
    endif()
