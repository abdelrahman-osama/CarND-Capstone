...
if("TRUE" STREQUAL "TRUE")
  set(waypoint_updater_SOURCE_PREFIX /home/pc1/CarND-Capstone-HNEW/ros/src/waypoint_updater)
  set(waypoint_updater_DEVEL_PREFIX /home/pc1/CarND-Capstone-HNEW/ros/devel)
  ...
  set(waypoint_updater_INSTALL_PREFIX /home/pc1/CarND-Capstone-HNEW/ros/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'waypoint_updater' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pc1/CarND-Capstone-HNEW/ros/src/waypoint_updater/${idir}'.  ${_report}")
    endif()
