...
class DBWNode(object):
    ...
    def loop(self):
        ...
        while not rospy.is_shutdown():
            ...
            if hasattr(self, 'twist_command') and hasattr(self, 'current_velocity') and\
            hasattr(self, 'steering_fb') and hasattr(self, 'dbw_enabled'):
                args = {
                    'twist_command': self.twist_command,
                    'current_velocity': self.current_velocity,
                    'steering_fb': self.steering_fb
                }
    ...
    def steering_report_cb(self,msg):
        self.steering_fb = msg.steering_wheel_angle
